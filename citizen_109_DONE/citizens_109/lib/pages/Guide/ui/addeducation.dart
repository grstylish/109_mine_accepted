...
class AddEducationPage extends StatefulWidget {
  ...
  const AddEducationPage({Key key, @required this.controller})
      : super(key: key);
...
class _AddEducationPageState extends State<AddEducationPage> {
    ...
    return BlocBuilder<LanguageBloc, LanguageState>(builder: (context, state) {
      ...
      return Column(
        children: [
          buildChangePage1(),
          buildText(),
          buildAddEducationInformation(),
        ],
      );
    });
  }

  Widget buildAddEducationInformation() {
    return BlocBuilder<GuideBloc, GuideState>(builder: (context, state) {
      ...
      if (state is LoadedGuideAddEducationState) {
        return buildAddEducationBody(state.loadedguideaddeducation);
      }
  ...
  buildAddEducationBody(List<GuideAddEducation> list) {
    List<Widget> children = [];
    print("HERE AddEducation $list");
          ...
          child: Table(
            ...
            children: [
              ...
              TableRow(children: [
                ...
                buildTextFieldText(item.address)
              ]),
              TableRow(children: [
