...
class AppActiveFile extends StatefulWidget {
  final ActiveTraceName activeTraceName;

  const AppActiveFile({Key key, @required this.activeTraceName})
      : super(key: key);

  @override
  _AppActiveFileState createState() => _AppActiveFileState();
}

class _AppActiveFileState extends State<AppActiveFile> {
  ...
  Widget buildImage() {
    ...
    for (var item in activeTraceName.statuses.last.file) {
