...
class AnimalStatus1 extends StatefulWidget {
  final SearchTraceName searchTraceName;

  const AnimalStatus1({Key key, @required this.searchTraceName})
      : super(key: key);

  @override
  _AnimalStatus1State createState() => _AnimalStatus1State();
}

class _AnimalStatus1State extends State<AnimalStatus1> {
                        ...
                        ? () {
                            if (_formKey.currentState.validate() ||
                              ...
                              traceBloc.add(LoadSendEvaluationEvent(
                                  ...
                                  track_number: searchTraceName.track_number));
                            }
                          }
                        : null,
...
//Comment from operator
  Widget buildCommentOperator() {
    if (searchTraceName.comment == '' || searchTraceName.comment != null) {
      return Container(
